...
class CallToolHandler extends BaseHandler_js_1.BaseHandler {
    constructor(ollamaService, sessionContext) {
        super();
        this.ollamaService = ollamaService;
        this.sessionContext = sessionContext;
        this.modelValidator = new ModelValidator_js_1.ModelValidator(this.ollamaService.getConfig());
    }
...
const callToolHandler = (ollamaService, sessionContext) => new CallToolHandler(ollamaService, sessionContext);
exports.callToolHandler = callToolHandler;
