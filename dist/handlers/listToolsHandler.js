            ...
            tools: [
                {
                    ...
                    inputSchema: {
                        ...
                        properties: {
                            ...
                            auto_settings: {
                                type: 'boolean',
                                description: 'If true, auto-suggest temperature/timeout based on model name + prompt heuristics (can also be enabled via MCP_AUTO_MODEL_SETTINGS=1). Does not override explicitly provided temperature/timeout_ms.',
                            },
                        },
                        required: ['prompt'],
                    },
