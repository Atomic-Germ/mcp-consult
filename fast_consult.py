...
def make_ollama_request(endpoint: str, data: Optional[Dict[str, Any]] = None, timeout: int = OLLAMA_TIMEOUT) -> Dict[str, Any]:
    ...
    This supports both standard JSON responses and streaming NDJSON/chunked
    responses from Ollama's long-running generation endpoints.
    ...
    try:
        ...
        if endpoint == "/api/models" or not data:
            ...
            # Use streaming to handle chunked NDJSON responses (one JSON object per line)
