    ...
    return {
      tools: [
          ...
          inputSchema: {
            ...
            properties: {
              ...
              context: {
                type: "object",
                description:
                  "Optional context including code, previous results, and metadata",
                properties: {
                  code: {
                    type: "string",
                  ...
                  previous_results: {
                    type: "array",
                    description:
                      "Results from previous consultations in the chain",
                    items: { type: "string" },
                  },
                  metadata: {
                    type: "object",
        ...
        },
        {
          ...
          description:
            "Compare responses from multiple Ollama models on the same prompt",
          inputSchema: {
            type: "object",
            properties: {
              models: {
