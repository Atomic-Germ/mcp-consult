...
describe('FlowExecutor', () => {
  it('runs a single model step and persists memory', async () => {
    ...
    const flow: Flow = {
      id: 'flow1',
      steps: [{ id: 's1', model: 'm1', prompt: 'hi', memoryWrite: 'greeting' }],
    };
    ...
    const flow: Flow = {
      ...
      steps: [
        { id: 's1', model: 'm1', prompt: 'hi', memoryWrite: 'greeting' },
        {
          ...
          model: 'm1',
          prompt: 'should skip',
          condition: "memory.greeting.includes('nope')",
        },
      ],
    };
  ...
  it('retries failed calls up to retries count', async () => {
    ...
    const flow: Flow = {
      id: 'flow3',
      steps: [
        { id: 's1', model: 'm1', prompt: 'retry', retries: 2, backoffMs: 1, memoryWrite: 'out' },
      ],
    };
